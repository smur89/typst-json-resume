...
#import "../internal/schema.typ": str-type, content-type, number-type, date-string, uri-string, email-string
...
// Format-specialised string kinds coerce identically to `str` — the
// regex gate fires in `_validate`, not here, and the value flows
