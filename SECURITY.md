...
If you've found a security issue in `json-resume` — for example, a way for a
...
Instead, open a private report via [GitHub Security Advisories](https://github.com/smur89/typst-json-resume/security/advisories/new).
I'll acknowledge within a few days and work with you on a fix.

## Scope

`json-resume` is a Typst data-loading library — it reads a JSON file from
...
Only the most recent published release on [Typst Universe](https://typst.app/universe/package/json-resume)
receives fixes.
